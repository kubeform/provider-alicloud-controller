...
// AuditPolicyReconciler reconciles a AuditPolicy object
...
// +kubebuilder:rbac:groups=mongodb.alicloud.kubeform.com,resources=auditpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mongodb.alicloud.kubeform.com,resources=auditpolicies/status,verbs=get;update;patch

func (r *AuditPolicyReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("auditpolicy", req.NamespacedName)
...
func (r *AuditPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mongodbv1alpha1.AuditPolicy{}); err != nil {
			klog.Error(err, "unable to set up auditor", mongodbv1alpha1.AuditPolicy{}.APIVersion, mongodbv1alpha1.AuditPolicy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&mongodbv1alpha1.AuditPolicy{}).
