...
// +kubebuilder:rbac:groups=disk.alicloud.kubeform.com,resources=attachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=disk.alicloud.kubeform.com,resources=attachments/status,verbs=get;update;patch
...
func (r *AttachmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &diskv1alpha1.Attachment{}); err != nil {
			klog.Error(err, "unable to set up auditor", diskv1alpha1.Attachment{}.APIVersion, diskv1alpha1.Attachment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&diskv1alpha1.Attachment{}).
