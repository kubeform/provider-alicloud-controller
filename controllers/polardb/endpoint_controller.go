...
// +kubebuilder:rbac:groups=polardb.alicloud.kubeform.com,resources=endpoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=polardb.alicloud.kubeform.com,resources=endpoints/status,verbs=get;update;patch
...
func (r *EndpointReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &polardbv1alpha1.Endpoint{}); err != nil {
			klog.Error(err, "unable to set up auditor", polardbv1alpha1.Endpoint{}.APIVersion, polardbv1alpha1.Endpoint{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&polardbv1alpha1.Endpoint{}).
