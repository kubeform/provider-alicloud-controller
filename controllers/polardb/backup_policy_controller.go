...
// +kubebuilder:rbac:groups=polardb.alicloud.kubeform.com,resources=backuppolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=polardb.alicloud.kubeform.com,resources=backuppolicies/status,verbs=get;update;patch
...
func (r *BackupPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &polardbv1alpha1.BackupPolicy{}); err != nil {
			klog.Error(err, "unable to set up auditor", polardbv1alpha1.BackupPolicy{}.APIVersion, polardbv1alpha1.BackupPolicy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&polardbv1alpha1.BackupPolicy{}).
