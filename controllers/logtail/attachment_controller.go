...
// +kubebuilder:rbac:groups=logtail.alicloud.kubeform.com,resources=attachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=logtail.alicloud.kubeform.com,resources=attachments/status,verbs=get;update;patch
...
func (r *AttachmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &logtailv1alpha1.Attachment{}); err != nil {
			klog.Error(err, "unable to set up auditor", logtailv1alpha1.Attachment{}.APIVersion, logtailv1alpha1.Attachment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&logtailv1alpha1.Attachment{}).
