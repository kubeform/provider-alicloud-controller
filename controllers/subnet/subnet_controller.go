...
// +kubebuilder:rbac:groups=subnet.alicloud.kubeform.com,resources=subnets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=subnet.alicloud.kubeform.com,resources=subnets/status,verbs=get;update;patch
...
func (r *SubnetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &subnetv1alpha1.Subnet{}); err != nil {
			klog.Error(err, "unable to set up auditor", subnetv1alpha1.Subnet{}.APIVersion, subnetv1alpha1.Subnet{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&subnetv1alpha1.Subnet{}).
