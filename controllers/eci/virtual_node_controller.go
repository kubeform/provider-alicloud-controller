...
// +kubebuilder:rbac:groups=eci.alicloud.kubeform.com,resources=virtualnodes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eci.alicloud.kubeform.com,resources=virtualnodes/status,verbs=get;update;patch
...
func (r *VirtualNodeReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &eciv1alpha1.VirtualNode{}); err != nil {
			klog.Error(err, "unable to set up auditor", eciv1alpha1.VirtualNode{}.APIVersion, eciv1alpha1.VirtualNode{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&eciv1alpha1.VirtualNode{}).
