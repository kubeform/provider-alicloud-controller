...
// +kubebuilder:rbac:groups=mns.alicloud.kubeform.com,resources=queues,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mns.alicloud.kubeform.com,resources=queues/status,verbs=get;update;patch

func (r *QueueReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("queue", req.NamespacedName)
...
func (r *QueueReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mnsv1alpha1.Queue{}); err != nil {
			klog.Error(err, "unable to set up auditor", mnsv1alpha1.Queue{}.APIVersion, mnsv1alpha1.Queue{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&mnsv1alpha1.Queue{}).
