...
// +kubebuilder:rbac:groups=mns.alicloud.kubeform.com,resources=topics,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mns.alicloud.kubeform.com,resources=topics/status,verbs=get;update;patch
...
func (r *TopicReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mnsv1alpha1.Topic{}); err != nil {
			klog.Error(err, "unable to set up auditor", mnsv1alpha1.Topic{}.APIVersion, mnsv1alpha1.Topic{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&mnsv1alpha1.Topic{}).
