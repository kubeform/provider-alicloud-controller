...
// +kubebuilder:rbac:groups=nas.alicloud.kubeform.com,resources=filesystems,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=nas.alicloud.kubeform.com,resources=filesystems/status,verbs=get;update;patch
...
func (r *FileSystemReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &nasv1alpha1.FileSystem{}); err != nil {
			klog.Error(err, "unable to set up auditor", nasv1alpha1.FileSystem{}.APIVersion, nasv1alpha1.FileSystem{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&nasv1alpha1.FileSystem{}).
