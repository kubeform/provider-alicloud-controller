...
// +kubebuilder:rbac:groups=nas.alicloud.kubeform.com,resources=autosnapshotpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=nas.alicloud.kubeform.com,resources=autosnapshotpolicies/status,verbs=get;update;patch
...
func (r *AutoSnapshotPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &nasv1alpha1.AutoSnapshotPolicy{}); err != nil {
			klog.Error(err, "unable to set up auditor", nasv1alpha1.AutoSnapshotPolicy{}.APIVersion, nasv1alpha1.AutoSnapshotPolicy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&nasv1alpha1.AutoSnapshotPolicy{}).
