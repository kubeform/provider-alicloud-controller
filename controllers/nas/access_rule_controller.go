...
// +kubebuilder:rbac:groups=nas.alicloud.kubeform.com,resources=accessrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=nas.alicloud.kubeform.com,resources=accessrules/status,verbs=get;update;patch
...
func (r *AccessRuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &nasv1alpha1.AccessRule{}); err != nil {
			klog.Error(err, "unable to set up auditor", nasv1alpha1.AccessRule{}.APIVersion, nasv1alpha1.AccessRule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&nasv1alpha1.AccessRule{}).
