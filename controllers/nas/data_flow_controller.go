...
// +kubebuilder:rbac:groups=nas.alicloud.kubeform.com,resources=dataflows,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=nas.alicloud.kubeform.com,resources=dataflows/status,verbs=get;update;patch

func (r *DataFlowReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("dataflow", req.NamespacedName)
...
func (r *DataFlowReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &nasv1alpha1.DataFlow{}); err != nil {
			klog.Error(err, "unable to set up auditor", nasv1alpha1.DataFlow{}.APIVersion, nasv1alpha1.DataFlow{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&nasv1alpha1.DataFlow{}).
