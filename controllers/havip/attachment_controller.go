...
// +kubebuilder:rbac:groups=havip.alicloud.kubeform.com,resources=attachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=havip.alicloud.kubeform.com,resources=attachments/status,verbs=get;update;patch
...
func (r *AttachmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &havipv1alpha1.Attachment{}); err != nil {
			klog.Error(err, "unable to set up auditor", havipv1alpha1.Attachment{}.APIVersion, havipv1alpha1.Attachment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&havipv1alpha1.Attachment{}).
