...
// +kubebuilder:rbac:groups=eip.alicloud.kubeform.com,resources=eips,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eip.alicloud.kubeform.com,resources=eips/status,verbs=get;update;patch
...
func (r *EipReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Eip")
...
func (r *EipReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &eipv1alpha1.Eip{}); err != nil {
			klog.Error(err, "unable to set up auditor", eipv1alpha1.Eip{}.APIVersion, eipv1alpha1.Eip{}.Kind)
			return err
		}
	}
