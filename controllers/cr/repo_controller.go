...
// +kubebuilder:rbac:groups=cr.alicloud.kubeform.com,resources=repoes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cr.alicloud.kubeform.com,resources=repoes/status,verbs=get;update;patch
...
func (r *RepoReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &crv1alpha1.Repo{}); err != nil {
			klog.Error(err, "unable to set up auditor", crv1alpha1.Repo{}.APIVersion, crv1alpha1.Repo{}.Kind)
			return err
		}
	}
