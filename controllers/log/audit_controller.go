...
// +kubebuilder:rbac:groups=log.alicloud.kubeform.com,resources=audits,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=log.alicloud.kubeform.com,resources=audits/status,verbs=get;update;patch
...
func (r *AuditReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &logv1alpha1.Audit{}); err != nil {
			klog.Error(err, "unable to set up auditor", logv1alpha1.Audit{}.APIVersion, logv1alpha1.Audit{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&logv1alpha1.Audit{}).
