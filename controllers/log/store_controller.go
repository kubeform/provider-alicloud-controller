...
// +kubebuilder:rbac:groups=log.alicloud.kubeform.com,resources=stores,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=log.alicloud.kubeform.com,resources=stores/status,verbs=get;update;patch
...
func (r *StoreReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &logv1alpha1.Store{}); err != nil {
			klog.Error(err, "unable to set up auditor", logv1alpha1.Store{}.APIVersion, logv1alpha1.Store{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&logv1alpha1.Store{}).
