...
// +kubebuilder:rbac:groups=slb.alicloud.kubeform.com,resources=acls,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=slb.alicloud.kubeform.com,resources=acls/status,verbs=get;update;patch
...
func (r *AclReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &slbv1alpha1.Acl{}); err != nil {
			klog.Error(err, "unable to set up auditor", slbv1alpha1.Acl{}.APIVersion, slbv1alpha1.Acl{}.Kind)
			return err
		}
	}
