...
// +kubebuilder:rbac:groups=slb.alicloud.kubeform.com,resources=loadbalancers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=slb.alicloud.kubeform.com,resources=loadbalancers/status,verbs=get;update;patch
...
func (r *LoadBalancerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &slbv1alpha1.LoadBalancer{}); err != nil {
			klog.Error(err, "unable to set up auditor", slbv1alpha1.LoadBalancer{}.APIVersion, slbv1alpha1.LoadBalancer{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&slbv1alpha1.LoadBalancer{}).
