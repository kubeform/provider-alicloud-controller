...
// +kubebuilder:rbac:groups=oos.alicloud.kubeform.com,resources=executions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=oos.alicloud.kubeform.com,resources=executions/status,verbs=get;update;patch
...
func (r *ExecutionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &oosv1alpha1.Execution{}); err != nil {
			klog.Error(err, "unable to set up auditor", oosv1alpha1.Execution{}.APIVersion, oosv1alpha1.Execution{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&oosv1alpha1.Execution{}).
