...
// +kubebuilder:rbac:groups=oos.alicloud.kubeform.com,resources=patchbaselines,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=oos.alicloud.kubeform.com,resources=patchbaselines/status,verbs=get;update;patch
...
func (r *PatchBaselineReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &oosv1alpha1.PatchBaseline{}); err != nil {
			klog.Error(err, "unable to set up auditor", oosv1alpha1.PatchBaseline{}.APIVersion, oosv1alpha1.PatchBaseline{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&oosv1alpha1.PatchBaseline{}).
