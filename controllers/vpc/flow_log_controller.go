...
// +kubebuilder:rbac:groups=vpc.alicloud.kubeform.com,resources=flowlogs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=vpc.alicloud.kubeform.com,resources=flowlogs/status,verbs=get;update;patch
...
func (r *FlowLogReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &vpcv1alpha1.FlowLog{}); err != nil {
			klog.Error(err, "unable to set up auditor", vpcv1alpha1.FlowLog{}.APIVersion, vpcv1alpha1.FlowLog{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&vpcv1alpha1.FlowLog{}).
