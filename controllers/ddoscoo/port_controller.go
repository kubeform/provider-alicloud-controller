...
// +kubebuilder:rbac:groups=ddoscoo.alicloud.kubeform.com,resources=ports,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ddoscoo.alicloud.kubeform.com,resources=ports/status,verbs=get;update;patch

func (r *PortReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("port", req.NamespacedName)
...
func (r *PortReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ddoscoov1alpha1.Port{}); err != nil {
			klog.Error(err, "unable to set up auditor", ddoscoov1alpha1.Port{}.APIVersion, ddoscoov1alpha1.Port{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ddoscoov1alpha1.Port{}).
