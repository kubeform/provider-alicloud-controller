...
// +kubebuilder:rbac:groups=vpn.alicloud.kubeform.com,resources=routeentries,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=vpn.alicloud.kubeform.com,resources=routeentries/status,verbs=get;update;patch
...
func (r *RouteEntryReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &vpnv1alpha1.RouteEntry{}); err != nil {
			klog.Error(err, "unable to set up auditor", vpnv1alpha1.RouteEntry{}.APIVersion, vpnv1alpha1.RouteEntry{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&vpnv1alpha1.RouteEntry{}).
