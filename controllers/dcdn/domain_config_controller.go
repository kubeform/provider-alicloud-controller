...
// +kubebuilder:rbac:groups=dcdn.alicloud.kubeform.com,resources=domainconfigs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dcdn.alicloud.kubeform.com,resources=domainconfigs/status,verbs=get;update;patch
...
func (r *DomainConfigReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dcdnv1alpha1.DomainConfig{}); err != nil {
			klog.Error(err, "unable to set up auditor", dcdnv1alpha1.DomainConfig{}.APIVersion, dcdnv1alpha1.DomainConfig{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dcdnv1alpha1.DomainConfig{}).
