...
// +kubebuilder:rbac:groups=alb.alicloud.kubeform.com,resources=servergroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=alb.alicloud.kubeform.com,resources=servergroups/status,verbs=get;update;patch
...
func (r *ServerGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &albv1alpha1.ServerGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", albv1alpha1.ServerGroup{}.APIVersion, albv1alpha1.ServerGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&albv1alpha1.ServerGroup{}).
