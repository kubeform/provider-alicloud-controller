...
// +kubebuilder:rbac:groups=sae.alicloud.kubeform.com,resources=applications,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sae.alicloud.kubeform.com,resources=applications/status,verbs=get;update;patch
...
func (r *ApplicationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &saev1alpha1.Application{}); err != nil {
			klog.Error(err, "unable to set up auditor", saev1alpha1.Application{}.APIVersion, saev1alpha1.Application{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&saev1alpha1.Application{}).
...
func (r *ApplicationReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(fmt.Errorf("expected a Secret but go a %T", o), "failed to get secret for Application")
			return nil
		}
		...
		resourceList := &saev1alpha1.ApplicationList{}
