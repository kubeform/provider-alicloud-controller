...
// +kubebuilder:rbac:groups=sae.alicloud.kubeform.com,resources=configmaps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sae.alicloud.kubeform.com,resources=configmaps/status,verbs=get;update;patch
...
func (r *ConfigMapReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &saev1alpha1.ConfigMap{}); err != nil {
			klog.Error(err, "unable to set up auditor", saev1alpha1.ConfigMap{}.APIVersion, saev1alpha1.ConfigMap{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&saev1alpha1.ConfigMap{}).
