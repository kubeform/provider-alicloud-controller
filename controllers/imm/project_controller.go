...
// +kubebuilder:rbac:groups=imm.alicloud.kubeform.com,resources=projects,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=imm.alicloud.kubeform.com,resources=projects/status,verbs=get;update;patch
...
func (r *ProjectReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &immv1alpha1.Project{}); err != nil {
			klog.Error(err, "unable to set up auditor", immv1alpha1.Project{}.APIVersion, immv1alpha1.Project{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&immv1alpha1.Project{}).
