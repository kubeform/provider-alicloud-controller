...
// +kubebuilder:rbac:groups=cdn.alicloud.kubeform.com,resources=domainconfigs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cdn.alicloud.kubeform.com,resources=domainconfigs/status,verbs=get;update;patch
...
func (r *DomainConfigReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cdnv1alpha1.DomainConfig{}); err != nil {
			klog.Error(err, "unable to set up auditor", cdnv1alpha1.DomainConfig{}.APIVersion, cdnv1alpha1.DomainConfig{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cdnv1alpha1.DomainConfig{}).
