...
// +kubebuilder:rbac:groups=cdn.alicloud.kubeform.com,resources=domains,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cdn.alicloud.kubeform.com,resources=domains/status,verbs=get;update;patch
...
func (r *DomainReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cdnv1alpha1.Domain{}); err != nil {
			klog.Error(err, "unable to set up auditor", cdnv1alpha1.Domain{}.APIVersion, cdnv1alpha1.Domain{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cdnv1alpha1.Domain{}).
...
func (r *DomainReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Domain")
			return nil
		}
		...
		resourceList := &cdnv1alpha1.DomainList{}
