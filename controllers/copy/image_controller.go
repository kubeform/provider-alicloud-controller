...
// +kubebuilder:rbac:groups=copy.alicloud.kubeform.com,resources=images,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=copy.alicloud.kubeform.com,resources=images/status,verbs=get;update;patch
...
func (r *ImageReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &copyv1alpha1.Image{}); err != nil {
			klog.Error(err, "unable to set up auditor", copyv1alpha1.Image{}.APIVersion, copyv1alpha1.Image{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&copyv1alpha1.Image{}).
