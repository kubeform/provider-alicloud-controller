...
// +kubebuilder:rbac:groups=fc.alicloud.kubeform.com,resources=triggers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=fc.alicloud.kubeform.com,resources=triggers/status,verbs=get;update;patch
...
func (r *TriggerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Trigger")
...
func (r *TriggerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &fcv1alpha1.Trigger{}); err != nil {
			klog.Error(err, "unable to set up auditor", fcv1alpha1.Trigger{}.APIVersion, fcv1alpha1.Trigger{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&fcv1alpha1.Trigger{}).
