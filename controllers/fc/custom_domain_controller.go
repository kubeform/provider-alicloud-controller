...
// +kubebuilder:rbac:groups=fc.alicloud.kubeform.com,resources=customdomains,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=fc.alicloud.kubeform.com,resources=customdomains/status,verbs=get;update;patch

func (r *CustomDomainReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("customdomain", req.NamespacedName)
...
func (r *CustomDomainReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &fcv1alpha1.CustomDomain{}); err != nil {
			klog.Error(err, "unable to set up auditor", fcv1alpha1.CustomDomain{}.APIVersion, fcv1alpha1.CustomDomain{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&fcv1alpha1.CustomDomain{}).
...
func (r *CustomDomainReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for CustomDomain")
			return nil
		}
		...
		resourceList := &fcv1alpha1.CustomDomainList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list CustomDomain")
			return nil
		}
