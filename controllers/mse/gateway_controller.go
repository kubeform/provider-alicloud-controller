...
// +kubebuilder:rbac:groups=mse.alicloud.kubeform.com,resources=gateways,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mse.alicloud.kubeform.com,resources=gateways/status,verbs=get;update;patch
...
func (r *GatewayReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &msev1alpha1.Gateway{}); err != nil {
			klog.Error(err, "unable to set up auditor", msev1alpha1.Gateway{}.APIVersion, msev1alpha1.Gateway{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&msev1alpha1.Gateway{}).
