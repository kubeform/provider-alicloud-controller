...
// +kubebuilder:rbac:groups=image.alicloud.kubeform.com,resources=exports,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=image.alicloud.kubeform.com,resources=exports/status,verbs=get;update;patch
...
func (r *ExportReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Export")
...
func (r *ExportReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &imagev1alpha1.Export{}); err != nil {
			klog.Error(err, "unable to set up auditor", imagev1alpha1.Export{}.APIVersion, imagev1alpha1.Export{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&imagev1alpha1.Export{}).
