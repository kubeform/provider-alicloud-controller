...
// +kubebuilder:rbac:groups=network.alicloud.kubeform.com,resources=aclattachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.alicloud.kubeform.com,resources=aclattachments/status,verbs=get;update;patch
...
func (r *AclAttachmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &networkv1alpha1.AclAttachment{}); err != nil {
			klog.Error(err, "unable to set up auditor", networkv1alpha1.AclAttachment{}.APIVersion, networkv1alpha1.AclAttachment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&networkv1alpha1.AclAttachment{}).
