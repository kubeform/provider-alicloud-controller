...
// +kubebuilder:rbac:groups=network.alicloud.kubeform.com,resources=interfaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.alicloud.kubeform.com,resources=interfaces/status,verbs=get;update;patch
...
func (r *InterfaceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &networkv1alpha1.Interface{}); err != nil {
			klog.Error(err, "unable to set up auditor", networkv1alpha1.Interface{}.APIVersion, networkv1alpha1.Interface{}.Kind)
			return err
		}
	}
