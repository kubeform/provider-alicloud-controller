...
// +kubebuilder:rbac:groups=network.alicloud.kubeform.com,resources=acls,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.alicloud.kubeform.com,resources=acls/status,verbs=get;update;patch
...
func (r *AclReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &networkv1alpha1.Acl{}); err != nil {
			klog.Error(err, "unable to set up auditor", networkv1alpha1.Acl{}.APIVersion, networkv1alpha1.Acl{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&networkv1alpha1.Acl{}).
