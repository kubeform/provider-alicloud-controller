...
// +kubebuilder:rbac:groups=alikafka.alicloud.kubeform.com,resources=consumergroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=alikafka.alicloud.kubeform.com,resources=consumergroups/status,verbs=get;update;patch
...
func (r *ConsumerGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &alikafkav1alpha1.ConsumerGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", alikafkav1alpha1.ConsumerGroup{}.APIVersion, alikafkav1alpha1.ConsumerGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&alikafkav1alpha1.ConsumerGroup{}).
