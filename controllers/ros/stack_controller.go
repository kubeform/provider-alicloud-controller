...
// +kubebuilder:rbac:groups=ros.alicloud.kubeform.com,resources=stacks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ros.alicloud.kubeform.com,resources=stacks/status,verbs=get;update;patch
...
func (r *StackReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &rosv1alpha1.Stack{}); err != nil {
			klog.Error(err, "unable to set up auditor", rosv1alpha1.Stack{}.APIVersion, rosv1alpha1.Stack{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&rosv1alpha1.Stack{}).
