...
// +kubebuilder:rbac:groups=db.alicloud.kubeform.com,resources=accountprivileges,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=db.alicloud.kubeform.com,resources=accountprivileges/status,verbs=get;update;patch
...
func (r *AccountPrivilegeReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dbv1alpha1.AccountPrivilege{}); err != nil {
			klog.Error(err, "unable to set up auditor", dbv1alpha1.AccountPrivilege{}.APIVersion, dbv1alpha1.AccountPrivilege{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dbv1alpha1.AccountPrivilege{}).
