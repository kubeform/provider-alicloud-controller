...
// +kubebuilder:rbac:groups=db.alicloud.kubeform.com,resources=databases,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=db.alicloud.kubeform.com,resources=databases/status,verbs=get;update;patch
...
func (r *DatabaseReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dbv1alpha1.Database{}); err != nil {
			klog.Error(err, "unable to set up auditor", dbv1alpha1.Database{}.APIVersion, dbv1alpha1.Database{}.Kind)
			return err
		}
	}
