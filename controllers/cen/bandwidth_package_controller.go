...
// +kubebuilder:rbac:groups=cen.alicloud.kubeform.com,resources=bandwidthpackages,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cen.alicloud.kubeform.com,resources=bandwidthpackages/status,verbs=get;update;patch
...
func (r *BandwidthPackageReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cenv1alpha1.BandwidthPackage{}); err != nil {
			klog.Error(err, "unable to set up auditor", cenv1alpha1.BandwidthPackage{}.APIVersion, cenv1alpha1.BandwidthPackage{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cenv1alpha1.BandwidthPackage{}).
