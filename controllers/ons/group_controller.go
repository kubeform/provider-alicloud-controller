...
// +kubebuilder:rbac:groups=ons.alicloud.kubeform.com,resources=groups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ons.alicloud.kubeform.com,resources=groups/status,verbs=get;update;patch
...
func (r *GroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &onsv1alpha1.Group{}); err != nil {
			klog.Error(err, "unable to set up auditor", onsv1alpha1.Group{}.APIVersion, onsv1alpha1.Group{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&onsv1alpha1.Group{}).
