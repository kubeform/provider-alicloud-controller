...
// +kubebuilder:rbac:groups=dfs.alicloud.kubeform.com,resources=accessgroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dfs.alicloud.kubeform.com,resources=accessgroups/status,verbs=get;update;patch
...
func (r *AccessGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dfsv1alpha1.AccessGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", dfsv1alpha1.AccessGroup{}.APIVersion, dfsv1alpha1.AccessGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dfsv1alpha1.AccessGroup{}).
