...
// +kubebuilder:rbac:groups=maxcompute.alicloud.kubeform.com,resources=projects,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=maxcompute.alicloud.kubeform.com,resources=projects/status,verbs=get;update;patch
...
func (r *ProjectReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &maxcomputev1alpha1.Project{}); err != nil {
			klog.Error(err, "unable to set up auditor", maxcomputev1alpha1.Project{}.APIVersion, maxcomputev1alpha1.Project{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&maxcomputev1alpha1.Project{}).
