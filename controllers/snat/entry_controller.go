...
// +kubebuilder:rbac:groups=snat.alicloud.kubeform.com,resources=entries,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=snat.alicloud.kubeform.com,resources=entries/status,verbs=get;update;patch
...
func (r *EntryReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &snatv1alpha1.Entry{}); err != nil {
			klog.Error(err, "unable to set up auditor", snatv1alpha1.Entry{}.APIVersion, snatv1alpha1.Entry{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&snatv1alpha1.Entry{}).
