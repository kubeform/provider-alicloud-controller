...
// +kubebuilder:rbac:groups=ecp.alicloud.kubeform.com,resources=keypairs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ecp.alicloud.kubeform.com,resources=keypairs/status,verbs=get;update;patch
...
func (r *KeyPairReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ecpv1alpha1.KeyPair{}); err != nil {
			klog.Error(err, "unable to set up auditor", ecpv1alpha1.KeyPair{}.APIVersion, ecpv1alpha1.KeyPair{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ecpv1alpha1.KeyPair{}).
