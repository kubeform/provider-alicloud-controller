...
// +kubebuilder:rbac:groups=dbfs.alicloud.kubeform.com,resources=snapshots,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dbfs.alicloud.kubeform.com,resources=snapshots/status,verbs=get;update;patch
...
func (r *SnapshotReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dbfsv1alpha1.Snapshot{}); err != nil {
			klog.Error(err, "unable to set up auditor", dbfsv1alpha1.Snapshot{}.APIVersion, dbfsv1alpha1.Snapshot{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dbfsv1alpha1.Snapshot{}).
