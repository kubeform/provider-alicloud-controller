...
// +kubebuilder:rbac:groups=dns.alicloud.kubeform.com,resources=domainattachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dns.alicloud.kubeform.com,resources=domainattachments/status,verbs=get;update;patch
...
func (r *DomainAttachmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dnsv1alpha1.DomainAttachment{}); err != nil {
			klog.Error(err, "unable to set up auditor", dnsv1alpha1.DomainAttachment{}.APIVersion, dnsv1alpha1.DomainAttachment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dnsv1alpha1.DomainAttachment{}).
