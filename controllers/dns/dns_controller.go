...
// +kubebuilder:rbac:groups=dns.alicloud.kubeform.com,resources=dns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dns.alicloud.kubeform.com,resources=dns/status,verbs=get;update;patch
...
func (r *DnsReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dnsv1alpha1.Dns{}); err != nil {
			klog.Error(err, "unable to set up auditor", dnsv1alpha1.Dns{}.APIVersion, dnsv1alpha1.Dns{}.Kind)
			return err
		}
	}
