...
// +kubebuilder:rbac:groups=mhub.alicloud.kubeform.com,resources=products,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mhub.alicloud.kubeform.com,resources=products/status,verbs=get;update;patch
...
func (r *ProductReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mhubv1alpha1.Product{}); err != nil {
			klog.Error(err, "unable to set up auditor", mhubv1alpha1.Product{}.APIVersion, mhubv1alpha1.Product{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&mhubv1alpha1.Product{}).
