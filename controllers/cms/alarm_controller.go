...
// +kubebuilder:rbac:groups=cms.alicloud.kubeform.com,resources=alarms,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cms.alicloud.kubeform.com,resources=alarms/status,verbs=get;update;patch
...
func (r *AlarmReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cmsv1alpha1.Alarm{}); err != nil {
			klog.Error(err, "unable to set up auditor", cmsv1alpha1.Alarm{}.APIVersion, cmsv1alpha1.Alarm{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cmsv1alpha1.Alarm{}).
