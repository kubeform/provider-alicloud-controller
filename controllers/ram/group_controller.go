...
// +kubebuilder:rbac:groups=ram.alicloud.kubeform.com,resources=groups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ram.alicloud.kubeform.com,resources=groups/status,verbs=get;update;patch
...
func (r *GroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ramv1alpha1.Group{}); err != nil {
			klog.Error(err, "unable to set up auditor", ramv1alpha1.Group{}.APIVersion, ramv1alpha1.Group{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ramv1alpha1.Group{}).
