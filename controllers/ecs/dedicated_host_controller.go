...
// +kubebuilder:rbac:groups=ecs.alicloud.kubeform.com,resources=dedicatedhosts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ecs.alicloud.kubeform.com,resources=dedicatedhosts/status,verbs=get;update;patch
...
func (r *DedicatedHostReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ecsv1alpha1.DedicatedHost{}); err != nil {
			klog.Error(err, "unable to set up auditor", ecsv1alpha1.DedicatedHost{}.APIVersion, ecsv1alpha1.DedicatedHost{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ecsv1alpha1.DedicatedHost{}).
