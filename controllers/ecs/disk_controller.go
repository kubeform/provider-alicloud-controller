...
// +kubebuilder:rbac:groups=ecs.alicloud.kubeform.com,resources=disks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ecs.alicloud.kubeform.com,resources=disks/status,verbs=get;update;patch
...
func (r *DiskReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ecsv1alpha1.Disk{}); err != nil {
			klog.Error(err, "unable to set up auditor", ecsv1alpha1.Disk{}.APIVersion, ecsv1alpha1.Disk{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ecsv1alpha1.Disk{}).
