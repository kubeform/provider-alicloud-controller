...
// +kubebuilder:rbac:groups=ecs.alicloud.kubeform.com,resources=commands,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ecs.alicloud.kubeform.com,resources=commands/status,verbs=get;update;patch

func (r *CommandReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("command", req.NamespacedName)
...
func (r *CommandReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ecsv1alpha1.Command{}); err != nil {
			klog.Error(err, "unable to set up auditor", ecsv1alpha1.Command{}.APIVersion, ecsv1alpha1.Command{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ecsv1alpha1.Command{}).
