...
// +kubebuilder:rbac:groups=bastionhost.alicloud.kubeform.com,resources=hosts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bastionhost.alicloud.kubeform.com,resources=hosts/status,verbs=get;update;patch
...
func (r *HostReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &bastionhostv1alpha1.Host{}); err != nil {
			klog.Error(err, "unable to set up auditor", bastionhostv1alpha1.Host{}.APIVersion, bastionhostv1alpha1.Host{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&bastionhostv1alpha1.Host{}).
