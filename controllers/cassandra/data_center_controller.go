...
// +kubebuilder:rbac:groups=cassandra.alicloud.kubeform.com,resources=datacenters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cassandra.alicloud.kubeform.com,resources=datacenters/status,verbs=get;update;patch
...
func (r *DataCenterReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cassandrav1alpha1.DataCenter{}); err != nil {
			klog.Error(err, "unable to set up auditor", cassandrav1alpha1.DataCenter{}.APIVersion, cassandrav1alpha1.DataCenter{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cassandrav1alpha1.DataCenter{}).
