...
// +kubebuilder:rbac:groups=ga.alicloud.kubeform.com,resources=acls,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ga.alicloud.kubeform.com,resources=acls/status,verbs=get;update;patch
...
func (r *AclReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &gav1alpha1.Acl{}); err != nil {
			klog.Error(err, "unable to set up auditor", gav1alpha1.Acl{}.APIVersion, gav1alpha1.Acl{}.Kind)
			return err
		}
	}
