...
// +kubebuilder:rbac:groups=ga.alicloud.kubeform.com,resources=bandwidthpackages,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ga.alicloud.kubeform.com,resources=bandwidthpackages/status,verbs=get;update;patch
...
func (r *BandwidthPackageReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &gav1alpha1.BandwidthPackage{}); err != nil {
			klog.Error(err, "unable to set up auditor", gav1alpha1.BandwidthPackage{}.APIVersion, gav1alpha1.BandwidthPackage{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&gav1alpha1.BandwidthPackage{}).
