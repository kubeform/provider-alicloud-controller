...
// +kubebuilder:rbac:groups=ga.alicloud.kubeform.com,resources=listeners,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ga.alicloud.kubeform.com,resources=listeners/status,verbs=get;update;patch

func (r *ListenerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("listener", req.NamespacedName)
...
func (r *ListenerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &gav1alpha1.Listener{}); err != nil {
			klog.Error(err, "unable to set up auditor", gav1alpha1.Listener{}.APIVersion, gav1alpha1.Listener{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&gav1alpha1.Listener{}).
