...
// +kubebuilder:rbac:groups=ecd.alicloud.kubeform.com,resources=commands,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ecd.alicloud.kubeform.com,resources=commands/status,verbs=get;update;patch
...
func (r *CommandReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ecdv1alpha1.Command{}); err != nil {
			klog.Error(err, "unable to set up auditor", ecdv1alpha1.Command{}.APIVersion, ecdv1alpha1.Command{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ecdv1alpha1.Command{}).
