...
// +kubebuilder:rbac:groups=ecd.alicloud.kubeform.com,resources=images,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ecd.alicloud.kubeform.com,resources=images/status,verbs=get;update;patch
...
func (r *ImageReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ecdv1alpha1.Image{}); err != nil {
			klog.Error(err, "unable to set up auditor", ecdv1alpha1.Image{}.APIVersion, ecdv1alpha1.Image{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ecdv1alpha1.Image{}).
