...
// +kubebuilder:rbac:groups=gpdb.alicloud.kubeform.com,resources=connections,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=gpdb.alicloud.kubeform.com,resources=connections/status,verbs=get;update;patch
...
func (r *ConnectionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &gpdbv1alpha1.Connection{}); err != nil {
			klog.Error(err, "unable to set up auditor", gpdbv1alpha1.Connection{}.APIVersion, gpdbv1alpha1.Connection{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&gpdbv1alpha1.Connection{}).
