...
// +kubebuilder:rbac:groups=alidns.alicloud.kubeform.com,resources=addresspools,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=alidns.alicloud.kubeform.com,resources=addresspools/status,verbs=get;update;patch
...
func (r *AddressPoolReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch AddressPool")
...
func (r *AddressPoolReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &alidnsv1alpha1.AddressPool{}); err != nil {
			klog.Error(err, "unable to set up auditor", alidnsv1alpha1.AddressPool{}.APIVersion, alidnsv1alpha1.AddressPool{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&alidnsv1alpha1.AddressPool{}).
