...
// +kubebuilder:rbac:groups=alidns.alicloud.kubeform.com,resources=records,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=alidns.alicloud.kubeform.com,resources=records/status,verbs=get;update;patch
...
func (r *RecordReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &alidnsv1alpha1.Record{}); err != nil {
			klog.Error(err, "unable to set up auditor", alidnsv1alpha1.Record{}.APIVersion, alidnsv1alpha1.Record{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&alidnsv1alpha1.Record{}).
