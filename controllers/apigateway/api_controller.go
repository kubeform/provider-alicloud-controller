...
// +kubebuilder:rbac:groups=apigateway.alicloud.kubeform.com,resources=apis,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.alicloud.kubeform.com,resources=apis/status,verbs=get;update;patch
...
func (r *ApiReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Api")
...
func (r *ApiReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apigatewayv1alpha1.Api{}); err != nil {
			klog.Error(err, "unable to set up auditor", apigatewayv1alpha1.Api{}.APIVersion, apigatewayv1alpha1.Api{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apigatewayv1alpha1.Api{}).
