...
// +kubebuilder:rbac:groups=rdc.alicloud.kubeform.com,resources=organizations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=rdc.alicloud.kubeform.com,resources=organizations/status,verbs=get;update;patch
...
func (r *OrganizationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &rdcv1alpha1.Organization{}); err != nil {
			klog.Error(err, "unable to set up auditor", rdcv1alpha1.Organization{}.APIVersion, rdcv1alpha1.Organization{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&rdcv1alpha1.Organization{}).
