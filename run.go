...
import (
	...
	alicloudscheme "kubeform.dev/provider-alicloud-api/client/clientset/versioned/scheme"
...
func init() {
	_ = alicloudscheme.AddToScheme(scheme)
...
func NewCmdRun(version string) *cobra.Command {
	cmd := &cobra.Command{
		Use:               "run",
		Short:             "Launch Kubeform alicloud Provider controller",
		DisableAutoGenTag: true,
		Run: func(cmd *cobra.Command, args []string) {
			klog.Infoln("Starting provider-alicloud-controller...")
			...
			mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
				...
				LeaderElectionID:       "alicloud.kubeform.com",
			})
			if err != nil {
