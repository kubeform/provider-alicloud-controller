...
func (in *HistoryDeliveryJobSpec) DeepCopyInto(out *HistoryDeliveryJobSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(HistoryDeliveryJobSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HistoryDeliveryJobSpecResource) DeepCopyInto(out *HistoryDeliveryJobSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *HistoryDeliveryJobSpecResource) DeepCopy() *HistoryDeliveryJobSpecResource {
	if in == nil {
		return nil
	}
	out := new(HistoryDeliveryJobSpecResource)
