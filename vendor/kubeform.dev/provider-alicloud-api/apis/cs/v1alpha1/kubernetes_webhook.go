...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-cs-alicloud-kubeform-com-v1alpha1-kubernetes,mutating=false,failurePolicy=fail,groups=cs.alicloud.kubeform.com,resources=kubernetes,versions=v1alpha1,name=kubernetes.cs.alicloud.kubeform.io,sideEffects=None,admissionReviewVersions=v1
...
var kubernetesForceNewList = map[string]bool{
	...
	"/master_disk_performance_level":  true,
	"/master_disk_snapshot_policy_id": true,
