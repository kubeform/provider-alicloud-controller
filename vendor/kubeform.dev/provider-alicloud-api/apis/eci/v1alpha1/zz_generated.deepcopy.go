...
func (in *ContainerGroupSpecImageRegistryCredential) DeepCopy() *ContainerGroupSpecImageRegistryCredential {
	...
	out := new(ContainerGroupSpecImageRegistryCredential)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ContainerGroupSpecResource) DeepCopyInto(out *ContainerGroupSpecResource) {
	*out = *in
	...
	if in.ImageRegistryCredential != nil {
		...
		*out = make([]ContainerGroupSpecImageRegistryCredential, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *VirtualNodeSpec) DeepCopyInto(out *VirtualNodeSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(VirtualNodeSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *VirtualNodeSpecResource) DeepCopyInto(out *VirtualNodeSpecResource) {
	*out = *in
	...
	if in.Taints != nil {
		...
		*out = make([]VirtualNodeSpecTaints, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *VirtualNodeSpecTaints) DeepCopy() *VirtualNodeSpecTaints {
	if in == nil {
		return nil
	}
	out := new(VirtualNodeSpecTaints)
	in.DeepCopyInto(out)
	return out
}
