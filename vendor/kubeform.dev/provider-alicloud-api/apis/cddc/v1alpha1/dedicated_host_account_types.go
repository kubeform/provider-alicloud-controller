...
type DedicatedHostAccount struct {
	...
	Spec              DedicatedHostAccountSpec   `json:"spec,omitempty"`
	Status            DedicatedHostAccountStatus `json:"status,omitempty"`
}

type DedicatedHostAccountSpec struct {
	State *DedicatedHostAccountSpecResource `json:"state,omitempty" tf:"-"`

	Resource DedicatedHostAccountSpecResource `json:"resource" tf:"resource"`
...
type DedicatedHostAccountSpecResource struct {
...
type DedicatedHostAccountList struct {
	...
	// Items is a list of DedicatedHostAccount CRD objects
	Items []DedicatedHostAccount `json:"items,omitempty"`
}
