...
type DeviceGroupSpecResource struct {
	...
	// +optional
	GroupDesc *string `json:"groupDesc,omitempty" tf:"group_desc"`
	GroupName *string `json:"groupName" tf:"group_name"`
	// +optional
	IotInstanceID *string `json:"iotInstanceID,omitempty" tf:"iot_instance_id"`
	// +optional
	SuperGroupID *string `json:"superGroupID,omitempty" tf:"super_group_id"`
}
