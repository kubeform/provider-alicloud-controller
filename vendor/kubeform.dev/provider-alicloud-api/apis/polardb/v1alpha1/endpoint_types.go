...
type EndpointSpecResource struct {
	...
	// +optional
	AutoAddNewNodes *string `json:"autoAddNewNodes,omitempty" tf:"auto_add_new_nodes"`
	DbClusterID     *string `json:"dbClusterID" tf:"db_cluster_id"`
	// +optional
	EndpointConfig map[string]string `json:"endpointConfig,omitempty" tf:"endpoint_config"`
	// +optional
