...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-drds-alicloud-kubeform-com-v1alpha1-instance,mutating=false,failurePolicy=fail,groups=drds.alicloud.kubeform.com,resources=instances,versions=v1alpha1,name=instance.drds.alicloud.kubeform.io,sideEffects=None,admissionReviewVersions=v1

var _ webhook.Validator = &Instance{}

var instanceForceNewList = map[string]bool{
	"/instance_charge_type": true,
	"/instance_series":      true,
	"/specification":        true,
	"/vswitch_id":           true,
	"/zone_id":              true,
}
