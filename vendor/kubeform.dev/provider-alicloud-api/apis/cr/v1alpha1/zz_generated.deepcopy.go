...
func (in *ChartNamespaceSpec) DeepCopyInto(out *ChartNamespaceSpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(ChartNamespaceSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChartNamespaceSpecResource) DeepCopyInto(out *ChartNamespaceSpecResource) {
	*out = *in
...
func (in *ChartNamespaceSpecResource) DeepCopy() *ChartNamespaceSpecResource {
	if in == nil {
		return nil
	}
	out := new(ChartNamespaceSpecResource)
...
func (in *ChartRepositorySpec) DeepCopyInto(out *ChartRepositorySpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(ChartRepositorySpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChartRepositorySpecResource) DeepCopyInto(out *ChartRepositorySpecResource) {
	*out = *in
	if in.InstanceID != nil {
		in, out := &in.InstanceID, &out.InstanceID
		*out = new(string)
...
func (in *ChartRepositorySpecResource) DeepCopy() *ChartRepositorySpecResource {
	if in == nil {
		return nil
	}
	out := new(ChartRepositorySpecResource)
...
func (in *EndpointACLPolicySpec) DeepCopyInto(out *EndpointACLPolicySpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(EndpointACLPolicySpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EndpointACLPolicySpecResource) DeepCopyInto(out *EndpointACLPolicySpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *EndpointACLPolicySpecResource) DeepCopy() *EndpointACLPolicySpecResource {
	if in == nil {
		return nil
	}
	out := new(EndpointACLPolicySpecResource)
