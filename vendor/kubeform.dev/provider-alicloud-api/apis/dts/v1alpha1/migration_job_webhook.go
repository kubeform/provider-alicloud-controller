...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-dts-alicloud-kubeform-com-v1alpha1-migrationjob,mutating=false,failurePolicy=fail,groups=dts.alicloud.kubeform.com,resources=migrationjobs,versions=v1alpha1,name=migrationjob.dts.alicloud.kubeform.io,sideEffects=None,admissionReviewVersions=v1

var _ webhook.Validator = &MigrationJob{}

var migrationjobForceNewList = map[string]bool{
	"/checkpoint":                         true,
...
func (r *MigrationJob) ValidateUpdate(old runtime.Object) error {
	...
	for key, _ := range migrationjobForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`migrationjob "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
...
func (r *MigrationJob) ValidateDelete() error {
	if r.Spec.TerminationPolicy == base.TerminationPolicyDoNotTerminate {
		return fmt.Errorf(`migrationjob "%v/%v" can't be terminated. To delete, change spec.terminationPolicy to Delete`, r.Namespace, r.Name)
	}
	return nil
}
