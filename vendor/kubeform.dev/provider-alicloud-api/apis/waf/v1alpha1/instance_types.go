...
type InstanceSpecResource struct {
	...
	BigScreen          *string `json:"bigScreen" tf:"big_screen"`
	ExclusiveIPPackage *string `json:"exclusiveIPPackage" tf:"exclusive_ip_package"`
	ExtBandwidth       *string `json:"extBandwidth" tf:"ext_bandwidth"`
	ExtDomainPackage   *string `json:"extDomainPackage" tf:"ext_domain_package"`
	LogStorage         *string `json:"logStorage" tf:"log_storage"`
	LogTime            *string `json:"logTime" tf:"log_time"`
	// +optional
	ModifyType  *string `json:"modifyType,omitempty" tf:"modify_type"`
	PackageCode *string `json:"packageCode" tf:"package_code"`
	// +optional
	...
	WafLog           *string `json:"wafLog" tf:"waf_log"`
}
