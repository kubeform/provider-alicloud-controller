...
func (in *TlsCipherPolicySpec) DeepCopyInto(out *TlsCipherPolicySpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(TlsCipherPolicySpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TlsCipherPolicySpecResource) DeepCopyInto(out *TlsCipherPolicySpecResource) {
	*out = *in
	if in.Ciphers != nil {
...
func (in *TlsCipherPolicySpecResource) DeepCopy() *TlsCipherPolicySpecResource {
	if in == nil {
		return nil
	}
	out := new(TlsCipherPolicySpecResource)
