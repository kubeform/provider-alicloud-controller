...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-instance-alicloud-kubeform-com-v1alpha1-instance,mutating=false,failurePolicy=fail,groups=instance.alicloud.kubeform.com,resources=instances,versions=v1alpha1,name=instance.instance.alicloud.kubeform.io,sideEffects=None,admissionReviewVersions=v1

var _ webhook.Validator = &Instance{}

var instanceForceNewList = map[string]bool{
	"/availability_zone":                    true,
	"/data_disks/*/auto_snapshot_policy_id": true,
	"/data_disks/*/category":                true,
	"/data_disks/*/delete_with_instance":    true,
	"/data_disks/*/description":             true,
	"/data_disks/*/encrypted":               true,
	...
	"/spot_price_limit":                     true,
	"/spot_strategy":                        true,
	"/system_disk_auto_snapshot_policy_id":  true,
	"/system_disk_category":                 true,
}
