...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-emr-alicloud-kubeform-com-v1alpha1-cluster,mutating=false,failurePolicy=fail,groups=emr.alicloud.kubeform.com,resources=clusters,versions=v1alpha1,name=cluster.emr.alicloud.kubeform.io,sideEffects=None,admissionReviewVersions=v1
...
var clusterForceNewList = map[string]bool{
	...
	"/key_pair_name":             true,
	"/master_pwd":                true,
	"/option_software_list":      true,
	"/related_cluster_id":        true,
	"/security_group_id":         true,
	"/ssh_enable":                true,
	"/use_local_metadb":          true,
	"/user_defined_emr_ecs_role": true,
	"/vswitch_id":                true,
	"/zone_id":                   true,
}
