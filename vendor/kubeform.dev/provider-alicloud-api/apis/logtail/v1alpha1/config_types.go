...
type ConfigSpecResource struct {
	...
	InputDetail *string `json:"inputDetail" tf:"input_detail"`
	InputType   *string `json:"inputType" tf:"input_type"`
	// +optional
	LogSample  *string `json:"logSample,omitempty" tf:"log_sample"`
	Logstore   *string `json:"logstore" tf:"logstore"`
	Name       *string `json:"name" tf:"name"`
	OutputType *string `json:"outputType" tf:"output_type"`
