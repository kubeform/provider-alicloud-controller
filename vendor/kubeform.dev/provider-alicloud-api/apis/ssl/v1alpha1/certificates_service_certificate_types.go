...
type CertificatesServiceCertificate struct {
	...
	Spec              CertificatesServiceCertificateSpec   `json:"spec,omitempty"`
	Status            CertificatesServiceCertificateStatus `json:"status,omitempty"`
}

type CertificatesServiceCertificateSpec struct {
	State *CertificatesServiceCertificateSpecResource `json:"state,omitempty" tf:"-"`

	Resource CertificatesServiceCertificateSpecResource `json:"resource" tf:"resource"`
...
type CertificatesServiceCertificateSpecResource struct {
...
type CertificatesServiceCertificateList struct {
	...
	// Items is a list of CertificatesServiceCertificate CRD objects
	Items []CertificatesServiceCertificate `json:"items,omitempty"`
}
