...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-dcdn-alicloud-kubeform-com-v1alpha1-domain,mutating=false,failurePolicy=fail,groups=dcdn.alicloud.kubeform.com,resources=domains,versions=v1alpha1,name=domain.dcdn.alicloud.kubeform.io,sideEffects=None,admissionReviewVersions=v1
