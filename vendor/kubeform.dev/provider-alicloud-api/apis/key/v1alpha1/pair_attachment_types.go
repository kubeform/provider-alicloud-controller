...
type PairAttachment struct {
	...
	Spec              PairAttachmentSpec   `json:"spec,omitempty"`
	Status            PairAttachmentStatus `json:"status,omitempty"`
}

type PairAttachmentSpec struct {
	State *PairAttachmentSpecResource `json:"state,omitempty" tf:"-"`

	Resource PairAttachmentSpecResource `json:"resource" tf:"resource"`
...
type PairAttachmentSpecResource struct {
...
// PairAttachmentList is a list of PairAttachments
type PairAttachmentList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of PairAttachment CRD objects
	Items []PairAttachment `json:"items,omitempty"`
}
