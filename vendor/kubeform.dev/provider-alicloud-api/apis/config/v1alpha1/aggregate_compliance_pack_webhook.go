...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-config-alicloud-kubeform-com-v1alpha1-aggregatecompliancepack,mutating=false,failurePolicy=fail,groups=config.alicloud.kubeform.com,resources=aggregatecompliancepacks,versions=v1alpha1,name=aggregatecompliancepack.config.alicloud.kubeform.io,sideEffects=None,admissionReviewVersions=v1
...
func (r *AggregateCompliancePack) ValidateUpdate(old runtime.Object) error {
	...
	res := old.(*AggregateCompliancePack)
	...
	for key := range aggregatecompliancepackForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`aggregatecompliancepack "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
...
func (r *AggregateCompliancePack) ValidateDelete() error {
	if r.Spec.TerminationPolicy == base.TerminationPolicyDoNotTerminate {
		return fmt.Errorf(`aggregatecompliancepack "%v/%v" can't be terminated. To delete, change spec.terminationPolicy to Delete`, r.Namespace, r.Name)
	}
	return nil
}
