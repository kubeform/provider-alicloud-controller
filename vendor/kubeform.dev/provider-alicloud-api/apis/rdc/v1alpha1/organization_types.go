...
type OrganizationSpecResource struct {
	...
	// +optional
	DesiredMemberCount *int64  `json:"desiredMemberCount,omitempty" tf:"desired_member_count"`
	OrganizationName   *string `json:"organizationName" tf:"organization_name"`
	// +optional
	RealPk *string `json:"realPk,omitempty" tf:"real_pk"`
