...
type DomainSpecSources struct {
	SourceContent *string `json:"sourceContent" tf:"source_content"`
	SourcePort    *string `json:"sourcePort" tf:"source_port"`
	// +optional
	SourcePriority *string `json:"sourcePriority,omitempty" tf:"source_priority"`
...
type DomainSpecResource struct {
	...
	// +optional
	GmtCreated *string `json:"gmtCreated,omitempty" tf:"gmt_created"`
	// +optional
