...
func (in *SecurityPreferenceSpec) DeepCopyInto(out *SecurityPreferenceSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(SecurityPreferenceSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SecurityPreferenceSpecResource) DeepCopyInto(out *SecurityPreferenceSpecResource) {
	*out = *in
...
func (in *SecurityPreferenceSpecResource) DeepCopy() *SecurityPreferenceSpecResource {
	if in == nil {
		return nil
	}
	out := new(SecurityPreferenceSpecResource)
