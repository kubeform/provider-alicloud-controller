...
type TableAttachment struct {
	...
	Spec              TableAttachmentSpec   `json:"spec,omitempty"`
	Status            TableAttachmentStatus `json:"status,omitempty"`
}

type TableAttachmentSpec struct {
	State *TableAttachmentSpecResource `json:"state,omitempty" tf:"-"`

	Resource TableAttachmentSpecResource `json:"resource" tf:"resource"`
...
type TableAttachmentSpecResource struct {
...
type TableAttachmentList struct {
	...
	// Items is a list of TableAttachment CRD objects
	Items []TableAttachment `json:"items,omitempty"`
}
