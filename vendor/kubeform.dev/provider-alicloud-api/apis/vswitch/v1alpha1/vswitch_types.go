...
type VswitchSpec struct {
	State *VswitchSpecResource `json:"state,omitempty" tf:"-"`

	Resource VswitchSpecResource `json:"resource" tf:"resource"`
...
type VswitchSpecResource struct {
...
type VswitchList struct {
	...
	// Items is a list of Vswitch CRD objects
	Items []Vswitch `json:"items,omitempty"`
}
