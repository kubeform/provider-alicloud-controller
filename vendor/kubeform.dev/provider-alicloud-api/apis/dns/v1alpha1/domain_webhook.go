...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-dns-alicloud-kubeform-com-v1alpha1-domain,mutating=false,failurePolicy=fail,groups=dns.alicloud.kubeform.com,resources=domains,versions=v1alpha1,name=domain.dns.alicloud.kubeform.io,sideEffects=None,admissionReviewVersions=v1
