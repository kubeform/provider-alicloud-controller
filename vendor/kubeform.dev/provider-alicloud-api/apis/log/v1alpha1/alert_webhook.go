...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-log-alicloud-kubeform-com-v1alpha1-alert,mutating=false,failurePolicy=fail,groups=log.alicloud.kubeform.com,resources=alerts,versions=v1alpha1,name=alert.log.alicloud.kubeform.io,sideEffects=None,admissionReviewVersions=v1
