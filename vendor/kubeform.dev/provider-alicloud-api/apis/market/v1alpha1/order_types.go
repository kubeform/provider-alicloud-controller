...
type OrderSpec struct {
	State *OrderSpecResource `json:"state,omitempty" tf:"-"`

	Resource OrderSpecResource `json:"resource" tf:"resource"`
...
type OrderSpecResource struct {
	ID string `json:"id,omitempty" tf:"id,omitempty"`

	// +optional
	Components map[string]string `json:"components,omitempty" tf:"components"`
	// +optional
	CouponID *string `json:"couponID,omitempty" tf:"coupon_id"`
	// +optional
	...
	PricingCycle *string `json:"pricingCycle" tf:"pricing_cycle"`
...
type OrderList struct {
	...
	// Items is a list of Order CRD objects
