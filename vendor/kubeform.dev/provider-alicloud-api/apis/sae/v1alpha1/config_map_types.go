...
type ConfigMapSpec struct {
	State *ConfigMapSpecResource `json:"state,omitempty" tf:"-"`

	Resource ConfigMapSpecResource `json:"resource" tf:"resource"`
...
type ConfigMapSpecResource struct {
...
type ConfigMapList struct {
	...
	// Items is a list of ConfigMap CRD objects
