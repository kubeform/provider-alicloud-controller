...
func (in *NasFileSystemSpec) DeepCopyInto(out *NasFileSystemSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(NasFileSystemSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NasFileSystemSpecResource) DeepCopyInto(out *NasFileSystemSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *NasFileSystemSpecResource) DeepCopy() *NasFileSystemSpecResource {
	if in == nil {
		return nil
	}
	out := new(NasFileSystemSpecResource)
...
func (in *NetworkPackageSpec) DeepCopyInto(out *NetworkPackageSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(NetworkPackageSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkPackageSpecResource) DeepCopyInto(out *NetworkPackageSpecResource) {
	*out = *in
	if in.Bandwidth != nil {
...
func (in *NetworkPackageSpecResource) DeepCopy() *NetworkPackageSpecResource {
	if in == nil {
		return nil
	}
	out := new(NetworkPackageSpecResource)
