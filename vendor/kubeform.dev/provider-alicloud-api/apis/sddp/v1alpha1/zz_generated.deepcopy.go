...
func (in *DataLimitSpecResource) DeepCopyInto(out *DataLimitSpecResource) {
	*out = *in
	...
	if in.LogStoreDay != nil {
		in, out := &in.LogStoreDay, &out.LogStoreDay
		*out = new(int64)
		**out = **in
	}
	if in.ParentID != nil {
...
func (in *DataLimitSpecResource) DeepCopy() *DataLimitSpecResource {
	if in == nil {
		return nil
	}
	out := new(DataLimitSpecResource)
