...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-security-alicloud-kubeform-com-v1alpha1-group,mutating=false,failurePolicy=fail,groups=security.alicloud.kubeform.com,resources=groups,versions=v1alpha1,name=group.security.alicloud.kubeform.io,sideEffects=None,admissionReviewVersions=v1

var _ webhook.Validator = &Group{}

var groupForceNewList = map[string]bool{
	"/security_group_type": true,
	"/vpc_id":              true,
}
