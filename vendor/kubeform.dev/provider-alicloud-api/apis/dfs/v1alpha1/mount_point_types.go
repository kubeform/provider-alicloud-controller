...
type MountPointSpec struct {
	State *MountPointSpecResource `json:"state,omitempty" tf:"-"`

	Resource MountPointSpecResource `json:"resource" tf:"resource"`
...
type MountPointSpecResource struct {
	...
	// +optional
	MountPointID *string `json:"mountPointID,omitempty" tf:"mount_point_id"`
...
type MountPointList struct {
	...
	// Items is a list of MountPoint CRD objects
	Items []MountPoint `json:"items,omitempty"`
}
