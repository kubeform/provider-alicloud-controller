...
type FileSystemSpecResource struct {
	...
	// +optional
	ProvisionedThroughputInMiBps *int64  `json:"provisionedThroughputInMiBps,omitempty" tf:"provisioned_throughput_in_mi_bps"`
	SpaceCapacity                *int64  `json:"spaceCapacity" tf:"space_capacity"`
	StorageType                  *string `json:"storageType" tf:"storage_type"`
	// +optional
	ThroughputMode *string `json:"-" sensitive:"true" tf:"throughput_mode"`
