...
type WorksFolder struct {
	...
	Spec              WorksFolderSpec   `json:"spec,omitempty"`
	Status            WorksFolderStatus `json:"status,omitempty"`
}

type WorksFolderSpec struct {
	State *WorksFolderSpecResource `json:"state,omitempty" tf:"-"`

	Resource WorksFolderSpecResource `json:"resource" tf:"resource"`
...
type WorksFolderSpecResource struct {
	...
	// +optional
	ProjectIdentifier *string `json:"projectIdentifier,omitempty" tf:"project_identifier"`
}
...
type WorksFolderList struct {
	...
	// Items is a list of WorksFolder CRD objects
	Items []WorksFolder `json:"items,omitempty"`
}
