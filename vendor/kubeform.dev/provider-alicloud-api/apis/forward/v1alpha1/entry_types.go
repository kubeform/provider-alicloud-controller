...
type EntrySpecResource struct {
	...
	ExternalIP   *string `json:"externalIP" tf:"external_ip"`
	ExternalPort *string `json:"externalPort" tf:"external_port"`
	// +optional
	ForwardEntryID *string `json:"forwardEntryID,omitempty" tf:"forward_entry_id"`
	// +optional
	ForwardEntryName *string `json:"forwardEntryName,omitempty" tf:"forward_entry_name"`
	ForwardTableID   *string `json:"forwardTableID" tf:"forward_table_id"`
	...
	// +optional
	PortBreak *bool `json:"portBreak,omitempty" tf:"port_break"`
	// +optional
