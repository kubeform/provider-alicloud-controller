...
func (in *AuditLogConfigSpec) DeepCopyInto(out *AuditLogConfigSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(AuditLogConfigSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AuditLogConfigSpecResource) DeepCopyInto(out *AuditLogConfigSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *AuditLogConfigSpecResource) DeepCopy() *AuditLogConfigSpecResource {
	if in == nil {
		return nil
	}
	out := new(AuditLogConfigSpecResource)
