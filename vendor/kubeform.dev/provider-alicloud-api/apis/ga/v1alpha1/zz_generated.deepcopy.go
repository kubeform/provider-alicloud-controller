...
func (in *AdditionalCertificateSpec) DeepCopyInto(out *AdditionalCertificateSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(AdditionalCertificateSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AdditionalCertificateSpecResource) DeepCopyInto(out *AdditionalCertificateSpecResource) {
	*out = *in
...
func (in *AdditionalCertificateSpecResource) DeepCopy() *AdditionalCertificateSpecResource {
	if in == nil {
		return nil
	}
	out := new(AdditionalCertificateSpecResource)
